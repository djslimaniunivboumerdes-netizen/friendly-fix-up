// DCS panels — using Supabase Storage (filenames match actual uploaded files)
...
export interface DcsPanel {
  ...
  section: string;
  unit?: string;
  storage_path: string; // exact filename as uploaded to Supabase Storage
  related_tags?: string[];
...
export const DCS_PANELS: DcsPanel[] = [
  ...
  { id: "fuel-gas", title_en: "Fuel Gas System", title_fr: "Système Fuel Gas", section: "Utilities", storage_path: "dcs/fuel gas sys.jpg" },
  { id: "fuel-gas-1", title_en: "Fuel Gas System 2", title_fr: "Système Fuel Gas 2", section: "Utilities", storage_path: "dcs/fuel gas sys-1.jpg" },
  ...
  { id: "echangeur-recup-gpl", title_en: "GPL Recovery Exchanger", title_fr: "Échangeur récup. GPL", section: "Recovery", storage_path: "dcs/echangeur de recuperation gpl.jpg" },
  { id: "retour-condensat", title_en: "Condensate Return Train", title_fr: "Retour Condensat Train", section: "Process", storage_path: "dcs/Retour Condensat train.jpg" },
  { id: "op-data-t100", title_en: "Operation Data T100", title_fr: "Données opération T100", section: "Operating Data", storage_path: "dcs/operation data T100.jpg" },
  { id: "op-data-t200", title_en: "Operation Data T200", title_fr: "Données opération T200", section: "Operating Data", storage_path: "dcs/operation data T200.jpg" },
  { id: "op-data-t300", title_en: "Operation Data T300", title_fr: "Données opération T300", section: "Operating Data", storage_path: "dcs/operation data T300.jpg" },
  { id: "op-data-t500", title_en: "Operation Data T500", title_fr: "Données opération T500", section: "Operating Data", storage_path: "dcs/operation data T500.jpg" },
  { id: "op-data-t600", title_en: "Operation Data T600", title_fr: "Données opération T600", section: "Operating Data", storage_path: "dcs/operation data T600.jpg" },
];
...
export function dcsImageUrl(storage_path: string): string {
  ...
  const encodedPath = storage_path.split('/').map(encodeURIComponent).join('/');
...
export function dcsImageViewUrl(storage_path: string): string {
  return dcsImageUrl(storage_path);
}
